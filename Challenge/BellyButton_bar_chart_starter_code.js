...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
   ...
   // var otuIdsResults = personStats.map(result => result.otu_ids);
    //console.log(otuIdsResults);
    var otuIdsResults = result1.otu_ids;
    console.log(otuIdsResults);
   // var otuLabelsResults = personStats.map(result => result.otu_labels);
    
    var otuLabelsResults = result1.otu_labels;
    console.log(otuLabelsResults);
    //var sampleResults = personStats.map(result => result.sample_values);
    ...
    //console.log(top10x);
    /*var top10y = otuIdsResults.slice(0,10);
    var top10x = sampleResults.slice(0,10);
    console.log(top10y);
    console.log(top10x);
    var yticks = top10y.reverse();
    console.log(yticks);
    var Labels = yticks.forEach(input => "OTU " + input);
    console.log(Labels);
    //var yticks = Labels.sort((a,b) => b-a);*/
